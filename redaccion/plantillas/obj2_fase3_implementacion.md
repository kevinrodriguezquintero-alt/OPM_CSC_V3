...
El modelo de ε-restricción (ER) del paper de Arenas & Salazar (2018) fue originalmente implementado en AMPL con solver GUROBI. Esta versión migra el modelo ER a Python + Pyomo, completando los pilares ambiental y social que en el paper original presentaban limitaciones de implementación.
