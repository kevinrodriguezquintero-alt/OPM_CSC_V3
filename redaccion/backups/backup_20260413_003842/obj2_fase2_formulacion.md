...
| F: ΣΣ CT_{ij}·Z_{ij}·DPI_{ij} | Costo de transporte flujo 1 (acopio→intermediario) — **CT en $/km/viaje** | $/semana |
| G: ΣΣ CTT_{jk}·ZZ_{jk}·DID_{jk} | Costo de transporte flujo 2 (intermediario→detallista) — **CTT en $/km/viaje** | $/semana |
...
> **✅ CORREGIDO:** El término de transporte ahora sigue la formulación del paper de Arenas & Salazar (2018): `CT·Z·DPI` y `CTT·ZZ·DID` (costo por km/viaje × número de viajes × distancia). CT y CTT están en **$/km/viaje**, dimensionalmente consistente con la función ambiental γ.
...
> Σ Y_{jk} ≤ CRI_j; ∀ j ∈ J &nbsp;&nbsp;&nbsp;(8) — **CRI_j: Capacidad de recepción/despacho del intermediario j**
...
> X_{ij}, Y_{jk}, W_i ∈ ℝ⁺ &nbsp;&nbsp;&nbsp;(23) — Variables continuas no negativas

> Z_{ij}, ZZ_{jk}, S, SS_j, SSS_k ∈ ℤ⁺ &nbsp;&nbsp;&nbsp;(24) — Variables enteras no negativas

> B_u ∈ {0, 1} &nbsp;&nbsp;&nbsp;(25) — Variables binarias
