...
|----------|-------------------------------|----------------------|---------------------|---------------|--------------|
| α (Costo) | g₁ = α* = 144496313.4276463 | 144496313.4276466 | 144500820.2034637 | 0 | {{PLACEHOLDER}} |
| γ (Emisiones) | g₂ = γ* = 1074.237824 | 1230.2681599995801 | 1212.473264 | 0 | {{PLACEHOLDER}} |
| β (Empleo) | g₃ = β* = 3088.0 | 1777.0 | 1777.0 | 0 | {{PLACEHOLDER}} |
...
| **Total** | 144496313.4276466 | 144500820.2034637 | {{PLACEHOLDER}} |
...
| **Total** | 1230.2681599995801 | 1212.473264 | {{PLACEHOLDER}} |
...
| **Total** | 1777.0 | 1777.0 | {{PLACEHOLDER}} |

Nota. Elaboración propia.

### Comparación con el Modelo de Referencia (Arenas & Salazar, 2018)

La comparación con el modelo de referencia original (Arenas & Salazar, 2018) permite validar la implementación. El paper incluye formulaciones matemáticas completas para los tres pilares de sostenibilidad (económico, ambiental, social), reportando resultados de: Costo $32.496.116,50, Emisiones 524,8 kg CO₂/semana, Empleo 179 personas/semana. Sin embargo, el código fuente AMPL disponible solo implementaba el pilar económico.

> **⚠️ Limitación de la comparación**: Los datos utilizados en esta implementación **no son los originales del paper**. La base de datos completa no estuvo disponible; los parámetros faltantes fueron completados mediante literatura secundaria (UPME, DANE, Santos et al., 2019). Por esta razón, **los valores numéricos de la tabla siguiente no se espera que coincidan exactamente con los del paper**, aunque el orden de magnitud y las tendencias deberían ser similares si el modelo está correctamente implementado. La validación se realiza por estructura matemática, no por igualdad numérica exacta.

Esta migración a Python + Pyomo implementa los tres pilares completos según las formulaciones del paper.

| Métrica | Paper (ER original) | ER (Python) | LGP (Python) |
|---------|-------------------|------------|-------------|
| Costo total | {{DATO:paper_costo}} | 144500820.2034637 | 144496313.4276466 |
| Emisiones | {{DATO:paper_emisiones}} | 1212.473264 | 1230.2681599995801 |
| Empleo | {{DATO:paper_empleo}} | 1777.0 | 1777.0 |
